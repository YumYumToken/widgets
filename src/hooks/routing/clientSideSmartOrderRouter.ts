...
import { BigintIsh, CurrencyAmount, Token, TradeType } from '@yumyumswap/sdk-core'
import type { AlphaRouterConfig } from '@yumyumswap/smart-order-router'
...
} from '@yumyumswap/smart-order-router'
...
function getRouter(chainId: ChainId, provider: BaseProvider): AlphaRouter {
  ...
  // TODO(zzmp): Upstream to @yumyumswap/smart-order-router, exporting an enum of supported v2 chains for clarity.
  ...
  // TODO(zzmp): Upstream to @yumyumswap/smart-order-router, possibly making this easier to modify
