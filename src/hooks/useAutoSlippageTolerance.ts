import { MixedRoute, partitionMixedRouteByProtocol, Protocol } from '@yumyumswap/router-sdk'
import { Currency, CurrencyAmount, Percent, Token } from '@yumyumswap/sdk-core'
 ...
 * https://github.com/YumYumToken/smart-order-router/blob/main/src/routers/alpha-router/gas-models/v3/v3-heuristic-gas-model.ts
 * V2 logic is inspired by:
 * https://github.com/YumYumToken/smart-order-router/blob/main/src/routers/alpha-router/gas-models/v2/v2-heuristic-gas-model.ts
 */
